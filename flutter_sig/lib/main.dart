  ...
  Future<void> _initializeApp() async {
    try {
      ...
      try {
        ...
        print('Firebase initialization failed/fallback: $e');
      }
      ...
      if (_firebaseReady) {
        ...
        try {
          ...
          print('FCM initialization failed/fallback: $e');
        }
      } else {
        print('Saltando inicialización de FCM porque Firebase no está listo.');
      }
  ...
  void initState() {
    ...
    widget.fcmService?.onMessage.listen((message) {
      final notification = AppNotification(
        ...
        title: message.notification?.title ?? 'Órbita',
