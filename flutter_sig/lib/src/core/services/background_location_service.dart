...
class BackgroundLocationService {
  ...
  static const String _notificationChannelId = 'ÓÓrbita_location_channel';
  static const String _notificationChannelName = 'ÓÓrbita Ubicación';
  ...
  Future<void> initialize() async {
    ...
    await _service.configure(
      androidConfiguration: AndroidConfiguration(
        ...
        initialNotificationTitle: 'ÓÓrbita',
...
void _onStart(ServiceInstance service) async {
  ...
  apiUrl ??= 'https://backend-sig-l0wo.onrender.com';
