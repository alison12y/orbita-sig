...
class _MapScreenState extends ConsumerState<MapScreen> {
  ...
  bool _isSatelliteView = true; // Vista satelital por defecto
            ...
            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      child.name.toLowerCase() == 'camila' ? 'Balu' : child.name,
              ...
              Positioned(
                ...
                child: FloatingActionButton.small(
                  ...
                  child: const Icon(Icons.refresh_rounded, color: Color(0xFF1A237E)),
                ),
              ),
              ...
              if (displayChildren.isNotEmpty)
                Positioned(
                  ...
                  child: FloatingActionButton.small(
                    ...
                    child: const Icon(Icons.my_location_rounded, color: Color(0xFF1A237E)),
                  ),
                ),
              ...
              if (_showRouteChildId != null)
                Positioned(
                  ...
                  child: FloatingActionButton.small(
                    ...
                    child: const Icon(Icons.route, color: Color(0xFF00BCD4)),
                  ),
                ),
            ],
          );
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: isOnline 
                        ? [const Color(0xFF1A237E), const Color(0xFF1A237E).withOpacity(0.8)]
