...
class ZonesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF5F7FA), // Light soft gray
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            Text('Órbita', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFF1A237E))),
            Text('Gestión de zonas', style: TextStyle(fontSize: 12, color: Colors.grey)),
          ],
        ),
      ),
      body: Column(
