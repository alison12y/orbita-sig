...
class _EditZoneScreenState extends ConsumerState<EditZoneScreen> {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      color: isSelected ? const Color(0xFF1A237E).withOpacity(0.1) : null,
                      child: CheckboxListTile(
                        ...
                        secondary: CircleAvatar(
                          backgroundColor: const Color(0xFF1A237E).withOpacity(0.2),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Editar Zona Segura', style: TextStyle(fontWeight: FontWeight.w800)),
                ...
                FlutterMap(
                  ...
                  children: [
                    TileLayer(
                      ...
                      userAgentPackageName: 'com.safesteps.orbita_mobile',
                    ),
                    // Polígono
                    PolygonLayer(
                      polygons: [
