...
class _ChildDetailScreenState extends ConsumerState<ChildDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.child.name.toLowerCase() == 'camila' ? 'Balu' : widget.child.name, style: const TextStyle(fontWeight: FontWeight.w800)),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  // Nombre
                  Text(
                    widget.child.name.toLowerCase() == 'camila' ? 'Balu' : widget.child.name,
                    style: const TextStyle(
                      fontSize: 24,
