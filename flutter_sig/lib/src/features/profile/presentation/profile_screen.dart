      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            Text(
              'Órbita',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFF1A237E)),
            ),
            Text('Gestión de perfil', style: TextStyle(fontSize: 12, color: Colors.grey)),
          ],
        ),
      ),
      body: Column(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [const Color(0xFF1A237E), const Color(0xFF1A237E).withOpacity(0.85)],
        ),
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              const Icon(Icons.add_rounded, size: 18, color: Color(0xFF1A237E)),
